...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sticky = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sticky = function (_React$Component) {
	  ...
	  Sticky.prototype.componentWillMount = function () {
	    function componentWillMount() {
	  ...
	  Sticky.prototype.componentWillReceiveProps = function () {
	  ...
	  Sticky.prototype.getXOffset = function () {
	    function getXOffset() {
	  ...
	  Sticky.prototype.getWidth = function () {
	    function getWidth() {
	  ...
	  Sticky.prototype.getHeight = function () {
	    function getHeight() {
	  ...
	  Sticky.prototype.getDistanceFromTop = function () {
	  ...
	  Sticky.prototype.getDistanceFromBottom = function () {
	    function getDistanceFromBottom() {
	      if (!this.containerNode) return 0;
	      return this.containerNode.getBoundingClientRect().bottom;
	    }

	    return getDistanceFromBottom;
	  }();

	  Sticky.prototype.isSticky = function () {
	    function isSticky() {
	  ...
	  Sticky.prototype.shouldComponentUpdate = function () {
	...
	Sticky.defaultProps = {
	  ...
	  onStickyStateChange: function () {
	    function onStickyStateChange() {}

	    return onStickyStateChange;
	  }()
	};
	Sticky.contextTypes = {
	  'sticky-channel': _react2['default'].PropTypes.any
